...
describe('Master actions', () => {
  ...
  it('Axios addMastersToDB success', () => {
    ...
    const expectedActions = [
      ...
      { type: types.ADD_MASTERS_SUCCESS, message: 'Master was successfully added.', payload: ['uzgorod'] },
  ...
  it('Axios addMastersToDB failure', () => {
    ...
    const expectedActions = [
      { type: types.ADD_MASTERS_STARTED },
      { type: types.ADD_MASTERS_FAILURE, payload: ['uzgorod', 'dnipro'] }
    ]
  ...
  it('Axios editMastersIntoDB success', () => {
    ...
    const expectedActions = [
      ...
      { type: types.EDIT_MASTERS_SUCCESS, message: 'Master was successfully edited.', payload: ['uzgorod'] },
      { type: types.REDIRECT_FROM_REFACTOR }
    ]
  ...
  it('Axios editMastersIntoDB failure', () => {
    ...
    const expectedActions = [
      { type: types.EDIT_MASTERS_STARTED },
      { type: types.EDIT_MASTERS_FAILURE, payload: ['uzgorod', 'dnipro'] }
    ]
  ...
  it('Axios deleteMastersFromDB success', () => {
    ...
    const expectedActions = [
      ...
      { type: types.DELETE_MASTERS_SUCCESS, message: 'Master was successfully removed.', payload: ['uzgorod'] }
    ]
  ...
  it('Axios deleteMastersFromDB failure', () => {
    ...
    const expectedActions = [
      { type: types.DELETE_MASTERS_STARTED },
      { type: types.DELETE_MASTERS_FAILURE, payload: ['uzgorod', 'dnipro'] }
    ]
